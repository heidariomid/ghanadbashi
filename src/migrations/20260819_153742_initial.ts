...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_orders_status" AS ENUM('new', 'confirmed', 'delivered', 'cancelled');
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"brand_brand_name" varchar NOT NULL,
  	"brand_tagline" varchar,
  	"brand_hero_image_id" integer NOT NULL,
  	"brand_about_text" jsonb,
  	"brand_about_image_id" integer,
  	"contact_phone" varchar,
  	"contact_whatsapp" varchar,
  	"contact_instagram" varchar,
  	"contact_service_area" varchar,
  ...
  ALTER TABLE "orders" ADD CONSTRAINT "orders_sample_image_id_media_id_fk" FOREIGN KEY ("sample_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "site_settings" ADD CONSTRAINT "site_settings_brand_hero_image_id_media_id_fk" FOREIGN KEY ("brand_hero_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "site_settings" ADD CONSTRAINT "site_settings_brand_about_image_id_media_id_fk" FOREIGN KEY ("brand_about_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "orders_sample_image_idx" ON "orders" USING btree ("sample_image_id");
  ...
  CREATE INDEX "site_settings_brand_brand_hero_image_idx" ON "site_settings" USING btree ("brand_hero_image_id");
  CREATE INDEX "site_settings_brand_brand_about_image_idx" ON "site_settings" USING btree ("brand_about_image_id");`)
}
